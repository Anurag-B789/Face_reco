...
lenTrain = lenData*splitRatio['train']
lenVal = lenData*splitRatio['val']
lenTest = lenData*splitRatio['test']
...
Output = [list(islice(Input, int(elem)))for elem in lengthToSplit]
